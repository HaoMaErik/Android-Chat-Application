...
public class NetworkListener {
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!action.equals(ConnectivityManager.CONNECTIVITY_ACTION) ||
                ...
                System.out.println("onReceived() called with \" + mState.toString() + \" and \" + intent");
                return;
            }
            ...
            System.out.println("onReceive(): mNetworkInfo=" + mNetworkInfo +  " mOtherNetworkInfo = "
                    + (mOtherNetworkInfo == null ? "[none]" : mOtherNetworkInfo +
                    " noConn=" + noConnectivity) + " mState=" + mState.toString());
            Toast.makeText(mainactivity, "Be alert! The internet is "+ mState.toString(),
     ...
     */
    public NetworkListener(FragmentActivity mainactivity) {
    ...
    public void registerHandler(Handler target, int what) {
        System.out.println("getinto listen");
